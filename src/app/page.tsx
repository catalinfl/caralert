...
export default function Home() {
  ...
  return (
    <main>
      <div className="flex flex-col bg-gradient-to-tr from-primary to-base rounded-lg min-h-[800px] p-5 mt-12 bg-pink-700 text-center md:text-start md:max-w-[1280px] w-full max-w-[400px] sm:max-w-[600px] mx-auto">
        <div className="flex h-[150px] sm:h-[200px]"> 
          <h1 className="text-4xl sm:text-6xl text-white font-bold">
            Foloseste pentru
            <span className="ml-2 sm:ml-4 bg-clip-text text-transparent bg-gradient-to-r from-secondary to-primary">
            <Typewriter 
        ...
        <div className="flex flex-grow md:flex-row flex-col gap-4 w-full justify-center items-center">
          <button className="btn btn-secondary md:ml-12 text-lg"> Sign in with Google </button>
          <button className="btn btn-secondary md:ml-12 text-lg"> See more about </button>
        </div>
      </div>
    </main>
  );
